...
const Resume = () => {
    ...
    return (
        <main className="!pt-0">
            ...
            <div className="flex flex-col gap-8 px-8 py-6 max-w-4xl mx-auto">
                <div className="flex flex-row justify-between items-center">
                    <div>
                        <h1 className="text-4xl font-bold">{resume.company}</h1>
                        <p className="text-gray-500 text-xl">{resume.job_title}</p>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <p className="text-5xl font-bold text-gradient">{resume.score}</p>
                ...
                <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col gap-4">
                    ...
                    <p className="text-gray-700 leading-relaxed">{resume.feedback}</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col gap-4">
                    ...
                    {coverLetter ? (
                        <p className="text-gray-700 leading-relaxed whitespace-pre-line">{coverLetter}</p>
                    ) : (
